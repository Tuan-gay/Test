...
class FullboysProvider : MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "$mainUrl/topic/video/asian/page-" to "Asian",
        "$mainUrl/topic/video/ass-licking/page-" to "Ass Licking",
        "$mainUrl/topic/video/blowjob/page-" to "Blowjob",
